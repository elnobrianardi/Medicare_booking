    ...
    <div className='container'>
      <div className='flex flex-col lg:flex-row gap-[90px] items-center justify-between'>
        <div className='lg:w-[570px]'>
          <h1 className='text-[46px] leading-[46px] text-headingColor font-[800] md:text-[60px] md:leading-[70px]'>
            We help patients live a healthy, longer life.
          </h1> 
          <p className='text-para'>
          Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
          Natus laborum sunt enim, culpa sed id est laborum. 
          </p>
        ...
        <div className='mt-[30px] lg:mt-[70px] flex flex-col  lg:flex-row lg:items-center gap-5 lg:gap-[30px]'>
          <div>
            <h2 className='rext-[36px] leading-[56px] lg:text-[44px] lg:leading-[54px] font-[700] text-headingColor'>
              30+
            </h2>
        ...
        <div className='py-[30px] px-5'>
          ...
          <div className='mt-[30px]'>
            ...
            <p className='text-[16px] leading-7 text-textColor font-[400] mt-4 text-center'>
              World class care for everyone. Our health System offers unmatched, expert helath care. From the lab to the clinic  
            </p>
            <Link to='/doctors' className='w-[44px] h-[44px] rounded-full border border-solid border-[#181A1e] mx-auto flex items-center
    ...
    <div className="container">
      <div className="xl:w-[470px] mx-auto">
        ...
        <p className="text-para text-center">
          World class for everyone. Our health System offers unmathed, expert health care.
        </p>
      </div>
      <ServiceList/>
    </div>
      ...
      <div className="flex items-center justify-between flex-col lg:flex-row">
        <div className="xl:w-[67opx] ">
          ...
          <ul className="pl-4">
            ...
            <li className="text-para">
              3. View our physicians who are accepting new patients, use the online shceduling tool to select an appoinment time.
            </li>
          </ul>
          <Link to='/'>
        ...
        <div className="relative z-10 xl:w-[770px] flex justify-end mt-[50px] lg:mt-0">
          ...
          md:bottom-[100px] md:left-5 z-20 pb-3 lg:pt-4 lg:px-4 lg:pb-[26px] rounded-[10px]">
