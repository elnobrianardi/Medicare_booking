          ...
          <div className="flex items-center gap-5">
            ...
            <div>
              ...
              <div className="flex items-center gap-[6px]">
                ...
                <span className='text-textColor text-[14px] leading-5 lg:text-[16px] lg:leading-7 font-[400]'>
                  (3.5k)
                </span>
              </div>
              <p className='text-para text-[14px] leading-6 md:text-[15px] lg:max-2-[390px]'>
